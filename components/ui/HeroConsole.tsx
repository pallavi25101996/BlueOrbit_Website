  ...
  return (
    <div aria-hidden="true" className="relative mx-auto w-full max-w-xl">
      ...
      <div className="overflow-hidden rounded-[20px] border border-black/[0.07] bg-surface shadow-card-hover">
        {/* Window chrome */}
        <div className="flex items-center gap-2 border-b border-black/[0.06] bg-surface-2/60 px-4 py-3">
        ...
        <div className="grid grid-cols-[76px_1fr]">
          {/* Sidebar */}
          <nav className="flex flex-col items-center gap-4 border-r border-black/[0.06] bg-surface-2/40 py-5">
          ...
          <div className="p-5">
            ...
            {/* Chart card */}
            <div className="mt-4 rounded-2xl border border-black/[0.06] bg-surface p-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-2xl border border-black/[0.06] bg-surface p-3">
      ...
      <div className="absolute -right-3 -top-5 hidden rounded-2xl border border-black/[0.07] bg-surface px-4 py-3 shadow-card sm:block">
      ...
      <div className="absolute -bottom-5 -left-3 hidden rounded-2xl border border-black/[0.07] bg-surface px-4 py-3 shadow-card sm:block">
        <div className="flex items-center gap-2.5">
